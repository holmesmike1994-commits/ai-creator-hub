...
const pages = [
    ...
    content: [
      section("Decision Table", "InstaDoodle alternatives at a glance.", table(
        ...
        [
          ...
          [`<a href="${official.videoScribe}" target="_blank" rel="noopener noreferrer"><strong>VideoScribe</strong></a>`, "Structured explainers, education, teams, and reseller workflows", "7-day free trial; annual equivalents from $12.50/month", "Download and video-length limits vary by plan"],
          ...
          [`<a href="${official.animaker}" target="_blank" rel="noopener noreferrer"><strong>Animaker</strong></a>`, "Character-heavy animation and multilingual voice workflows", "Free and paid platform; verify current whiteboard limits", "Broader interface and more choices to learn"],
      ...
      section("Recommendations", "Which alternative should you choose?", cards([
        ...
        { label: "Best trial path", title: "Choose VideoScribe", text: "Pick VideoScribe when you want to test before paying and compare clear limits for downloads, video length, assets, and reseller rights.", link: { href: official.videoScribe, label: "Visit VideoScribe", external: true } },
    ...
    content: [
      section("Decision Table", "Doodly competitors at a glance.", table(
        ...
        [
          ...
          [`<a href="${official.videoScribe}" target="_blank" rel="noopener noreferrer"><strong>VideoScribe</strong></a>`, "You want a free trial and clearer usage limits", "7-day trial; paid annual equivalents from $12.50/month", "Plan-based download and duration limits"],
          ...
          [`<a href="${official.animaker}" target="_blank" rel="noopener noreferrer"><strong>Animaker</strong></a>`, "You need character creation, templates, and multilingual audio", "Verify current free and paid whiteboard limits", "More features create a broader learning curve"],
      ...
      section("Best Matches", "Choose the replacement that fixes your real problem.", cards([
        ...
        { label: "Structured alternative", title: "VideoScribe", text: "Best when you want a trial, clear download limits, a large image library, preview links, and reseller rights on the appropriate plan.", link: { href: official.videoScribe, label: "View VideoScribe plans", external: true } },
  ...
  },
  {
    ...
    heroAside: `<p class="eyebrow">Quick Verdict</p><h2>Different strengths</h2><div class="comparison-score-grid"><div><span>InstaDoodle Score</span><strong>8.7 / 10</strong></div><div><span>VideoScribe Score</span><strong>Not yet scored</strong></div><div><span>Comparison confidence</span><strong>Moderate</strong></div></div><p>VideoScribe has not yet received a standalone AI Creator Hub evaluation, so no score has been invented for this comparison.</p>`,
    content: [
      ...
      section("Recommendation", "AI Creator Hub's current view.", `<p>InstaDoodle remains our current quick-start recommendation for creators whose central problem is generating the right doodle asset quickly. VideoScribe is the stronger risk-controlled purchase path because its free trial and published plan limits make evaluation easier.</p><p>That recommendation can change after VideoScribe receives a complete scored evaluation or if InstaDoodle simplifies its pricing presentation. Neither product is objectively better for every buyer.</p><div class="engine-hero-actions"><a class="button" href="${links.instaReview}">Read InstaDoodle Review</a><a class="button button--ghost" href="${official.videoScribe}" target="_blank" rel="noopener noreferrer">Visit VideoScribe</a></div>`),
      section("Related Content", "Keep comparing with context.", related([
        { href: links.instaDoodly, title: "InstaDoodle vs Doodly", text: "Compare two tools with full AI Creator Hub evaluations." },
    ...
    content: [
      section("Teacher Decision Table", "Choose by classroom workflow.", table(
        ...
        [
          ...
          ["Test a full workflow before purchasing", `<a href="${official.videoScribe}" target="_blank" rel="noopener noreferrer">VideoScribe</a>`, "Seven-day trial without payment details and three watermarked downloads"],
          ...
          ["Create character-led or multilingual lessons", `<a href="${official.animaker}" target="_blank" rel="noopener noreferrer">Animaker</a>`, "Published whiteboard features include character building, 100+ templates, voices, and subtitles"],
    ...
    content: [
      section("Creator Decision Table", "Choose by YouTube production need.", table(
        ...
        [
          ...
          ["Repeatable long-form or training videos", `<a href="${official.videoScribe}" target="_blank" rel="noopener noreferrer">VideoScribe</a>`, "Published limits cover duration, downloads, assets, voice, and preview links"],
          ...
          ["Character-led educational or entertainment video", `<a href="${official.animaker}" target="_blank" rel="noopener noreferrer">Animaker</a>`, "Character builder, templates, broad voices, subtitles, and animation assets"],
...
const pageHtml = (page) => {
  ...
  const articleSchema = {
    ...
    author: { "@type": "Organization", name: "AI Creator Hub", url: SITE },
...
<body data-active="${page.active}">
  ...
  <main class="main" id="main">
    ...
    <section class="engine-section"><div class="container narrow content-panel"><p class="eyebrow">Affiliate Disclosure</p><h2>Editorial judgment stays independent.</h2><p>AI Creator Hub may earn a commission from qualifying purchases made through the InstaDoodle partner link. Affiliate relationships do not determine scores, comparisons, or recommendations.</p><p><a href="${affiliateUrl}" target="_blank" rel="sponsored nofollow noopener noreferrer">Check the current InstaDoodle offer</a></p></div></section>
  </main>
